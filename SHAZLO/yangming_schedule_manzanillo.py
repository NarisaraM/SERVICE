...
==========================================
Shanghai (CNSHA) -> Manzanillo, Mexico (MXZLO)
...
point_to_point_search) calls a public JSON API under the hood:
    ...
    GET https://www.yangming.com/api/P2P/GetP2PRoutes
        ...
        &locationCodeTo=MXZLO&serviceTermTo=Y
...
Usage examples:
    ...
    python yangming_schedule_manzanillo.py
    python yangming_schedule_manzanillo.py --from 2026-09-01 --to 2026-11-30
    python yangming_schedule_manzanillo.py --pol CNSHA --pod MXZLO --out schedule.xlsx
"""
...
def main():
    ...
    parser.add_argument("--pod", default="MXZLO", help="Destination port code (default: MXZLO = Manzanillo, Mexico)")
    ...
    parser.add_argument("--out", default="yangming_schedule_manzanillo.xlsx",
