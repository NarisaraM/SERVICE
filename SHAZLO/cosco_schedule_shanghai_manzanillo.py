...
Route: Shanghai (CNSHA) -> Manzanillo, Colima, Mexico (MXZLO)
...
Usage
-----
    python cosco_schedule_shanghai_manzanillo.py
    python cosco_schedule_shanghai_manzanillo.py --from 2026-09-01 --to 2026-11-30
"""
...
# Shanghai and Manzanillo (Colima, Mexico - not to be confused with
# Manzanillo, Panama). These were captured from the live site and are
# stable (they are the site's own database IDs for the city pair).
ORIGIN_CITY_UUID = "738872886232873"
ORIGIN_CITY = "Shanghai,Shanghai,Shanghai,China,CNSHA"

DESTINATION_CITY_UUID = "738872886247648"
DESTINATION_CITY = "Manzanillo, ,Colima,Mexico,MXZLO"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Fetch COSCO SHIPPING Lines sailing schedule: Shanghai -> Manzanillo"
    )
    ...
    print(f"Fetching COSCO schedule: Shanghai -> Manzanillo, "
