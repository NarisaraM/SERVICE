...
==========================================
Shanghai (CNSHA) -> Laem Chabang (THLCB)
...
point_to_point_search) calls a public JSON API under the hood:
    ...
    GET https://www.yangming.com/api/P2P/GetP2PRoutes
        ...
        &locationCodeTo=THLCB&serviceTermTo=Y
...
Usage examples:
    ...
    python yangming_schedule.py
    python yangming_schedule.py --from 2026-09-01 --to 2026-11-30
    python yangming_schedule.py --pol CNSHA --pod THLCB --out schedule.xlsx
"""
...
def main():
    ...
    parser.add_argument("--pod", default="THLCB", help="Destination port code (default: THLCB = Laem Chabang)")
    ...
    parser.add_argument("--out", default="yangming_schedule.xlsx",
