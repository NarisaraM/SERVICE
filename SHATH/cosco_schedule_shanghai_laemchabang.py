...
Route: Shanghai (CNSHA) -> Laem Chabang (THLCB)
...
Usage
-----
    python cosco_schedule_shanghai_laemchabang.py
    python cosco_schedule_shanghai_laemchabang.py --from 2026-09-01 --to 2026-11-30
"""
...
# Shanghai and Laem Chabang. These were captured from the live site and are
...
DESTINATION_CITY_UUID = "738872886233472"
DESTINATION_CITY = "Laem Chabang, ,Chon Buri,Thailand,THLCB"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Fetch COSCO SHIPPING Lines sailing schedule: Shanghai -> Laem Chabang"
    )
    ...
    print(f"Fetching COSCO schedule: Shanghai -> Laem Chabang, "
