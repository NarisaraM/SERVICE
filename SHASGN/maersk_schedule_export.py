...
Pre-configured for: Shanghai, China (CNSGH)  ->  Ho Chi Minh City, Vietnam (VNSGN)
...
* The page/URL parameters below (from, to, fromRkstCode, toRkstCode, ...)
  were captured from the live "Shanghai -> Ho Chi Minh City" schedule search
  on maersk.com. If Maersk changes its site, you may need to redo the search
...
# Location codes as used by maersk.com for this lane (Shanghai -> Ho Chi Minh City)
FROM_LOCODE = "2IW9P6J7XAW72"   # Shanghai, China
TO_LOCODE = "27NYPRMI1Y9P8"     # Ho Chi Minh City, Vietnam
...
OUTPUT_FILE = "maersk_shanghai_to_hochiminh_sep_nov_2026.xlsx"
